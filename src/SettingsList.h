...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr) {
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Value(
            StrId::STR_SCRIPT_HEAP_RESERVE, &CrossPointSettings::scriptHeapReserveKb,
            {CrossPointSettings::MIN_SCRIPT_HEAP_RESERVE_KB, CrossPointSettings::MAX_SCRIPT_HEAP_RESERVE_KB,
